...
flowchart TD
    ...
    BRQ["<b>xr_budgetrequisition</b><br/>--------------------<br/>xr_budgetrequisitionid<br/>Project<br/>Vertical<br/>Budget Head<br/>Sub Budget Head<br/>Vendor Evaluation"]:::entity
...
| M     | <b>xr_budgetrequisition</b>.Vendor Evaluation looks up <b>xr_vendorevaluation</b>.xr_vendorevaluationid (`1:n`), storing the approved evaluation record for the same Project, Vertical, Budget Head, and Sub Budget Head context.                                                                                         |
