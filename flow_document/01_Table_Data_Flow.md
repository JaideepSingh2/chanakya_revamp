...
flowchart TD
    ...
    BRQ["<b>xr_budgetrequisition</b><br/>--------------------<br/>xr_budgetrequisitionid<br/>Project<br/>Vertical<br/>Budget Head<br/>Sub Budget Head<br/>Evaluated Vendor<br/>Start Date & Time<br/>End Date & Time"]:::entity
...
| L     | <b>systemuser</b> acts as an Approver and Requestor via lookups on <b>xr_vendoronboarding</b>, <b>xr_vendorevaluation</b>, <b>xr_budgetrequisition</b>, and <b>xr_budgetoperation</b>.                                                                                                                                  |
| M     | <b>xr_budgetrequisition</b>.Evaluated Vendor looks up <b>xr_vendorevaluation</b>.xr_vendorevaluationid (`1:n`), storing the approved evaluation record for the same Project, Vertical, Budget Head, and Sub Budget Head context.                                                                                     |
